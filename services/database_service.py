...
class DatabaseService:
    ...
    def get_user_sessions(self, user_id: str, limit: int = 20, 
        ...
        Returns:
            Dictionary containing sessions data and metadata
        """
        try:
    ...
    def get_session_by_id(self, session_id: str, user_id: str) -> Optional[Dict[str, Any]]:
        ...
        """
        try:
            doc_ref = self.db.collection('practice_sessions').document(session_id)
            doc = doc_ref.get()
    ...
    def get_user_statistics(self, user_id: str, period: str = 'month') -> Dict[str, Any]:
        ...
        try:
            ...
            for category in category_breakdown:
                ...
                del category_breakdown[category]['scores']  # Remove raw scores from response
    ...
    def save_feedback(self, feedback_data: Dict[str, Any]) -> str:
        ...
        try:
            ...
            # Convert datetime objects to Firestore timestamps
            feedback_data = self._prepare_for_firestore(feedback_data)
            
            # Save to Firestore
            doc_ref = self.db.collection('user_feedback').add(feedback_data)

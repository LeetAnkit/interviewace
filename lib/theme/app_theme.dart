...
class AppTheme {
  ...
  static const Color primaryLight = Color(0xFF2C3E50); // Deep professional blue
  static const Color primaryVariantLight =
      Color(0xFF34495E); // Supporting blue-gray
  static const Color secondaryLight =
      Color(0xFF3498DB); // Bright blue for progress
  static const Color accentLight = Color(0xFF3498DB); // Bright blue accent
  static const Color successLight =
      Color(0xFF27AE60); // Clean green for achievements
  static const Color warningLight =
      Color(0xFFF39C12); // Warm orange for guidance
  static const Color errorLight =
      Color(0xFFE74C3C); // Controlled red for technical issues
  static const Color backgroundLight = Color(0xFFFAFBFC); // Soft off-white
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white for content
  ...
  static const Color borderLight = Color(0xFFE8EAED); // Minimal borders
  ...
  /// Custom text styles for data display (scores, timestamps, technical feedback)
  ...
  /// Custom text styles for data display with medium weight
